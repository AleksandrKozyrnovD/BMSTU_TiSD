...
// void node_init(tree_node_t *node, int depth, tree_node_t *parent, tree_node_t *left, tree_node_t *riaght, int value, char option)
// {
//     node->depth = depth;
//     node->parent = parent;
//     node->left = left;
...
tree_node_t *create_tree(int arr[NUMS_COUNT])
{
